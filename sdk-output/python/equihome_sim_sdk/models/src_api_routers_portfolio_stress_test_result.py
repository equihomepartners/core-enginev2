...
class SrcApiRoutersPortfolioStressTestResult(BaseModel):
    """
    Stress test result model.
    """ # noqa: E501
    is_compliant: StrictBool = Field(description="Whether the test is compliant")
    details: Dict[str, Any] = Field(description="Test details")
    __properties: ClassVar[List[str]] = ["is_compliant", "details"]
