...
class LeverageVisualization(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["leverage_timeline", "facility_utilization", "interest_expense"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leverage_timeline": obj.get("leverage_timeline"),
            "facility_utilization": obj.get("facility_utilization"),
