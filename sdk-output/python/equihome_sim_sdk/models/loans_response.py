...
class LoansResponse(BaseModel):
    ...
    total_count: StrictInt = Field(description="Total number of loans")
    limit: StrictInt = Field(description="Maximum number of loans to return")
    offset: StrictInt = Field(description="Offset for pagination")
    __properties: ClassVar[List[str]] = ["loans", "total_count", "limit", "offset"]
