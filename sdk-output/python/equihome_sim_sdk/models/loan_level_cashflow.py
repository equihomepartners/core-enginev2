...
class LoanLevelCashflow(BaseModel):
    ...
    exit: Optional[Dict[str, Any]] = Field(default=None, description="Exit cashflows")
    __properties: ClassVar[List[str]] = ["loan_id", "origination", "exit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "origination": obj.get("origination"),
            "exit": obj.get("exit")
        })
        return _obj
