...
class FeeCalculationResponse(BaseModel):
    ...
    total_fees: Dict[str, Union[StrictFloat, StrictInt]] = Field(description="Total fees by category")
    fee_impact: Dict[str, Union[StrictFloat, StrictInt]] = Field(description="Impact of fees on fund performance")
    visualization: FeeVisualization = Field(description="Visualization data")
    __properties: ClassVar[List[str]] = ["simulation_id", "total_fees", "fee_impact", "visualization"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fee_impact": obj.get("fee_impact"),
            "visualization": FeeVisualization.from_dict(obj["visualization"]) if obj.get("visualization") is not None else None
        })
        return _obj
