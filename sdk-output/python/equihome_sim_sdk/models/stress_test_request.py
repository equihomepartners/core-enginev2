...
class StressTestRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["simulation_id", "scenarios"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scenarios": [StressTestScenario.from_dict(_item) for _item in obj["scenarios"]] if obj.get("scenarios") is not None else None
        })
        return _obj
