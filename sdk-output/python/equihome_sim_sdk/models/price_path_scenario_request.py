...
class PricePathScenarioRequest(BaseModel):
    ...
    """ # noqa: E501
    model_type: Optional[StrictStr] = Field(default='gbm', description="Type of stochastic model to use")
    ...
    __properties: ClassVar[List[str]] = ["model_type", "appreciation_rates", "volatility", "correlation_matrix", "time_step", "fund_term"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "model_type": obj.get("model_type") if obj.get("model_type") is not None else 'gbm',
