...
class CashflowTableItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["year", "capital_calls", "loan_investments", "origination_fees", "principal_repayments", "interest_income", "appreciation_share", "management_fees", "fund_expenses", "distributions", "net_cashflow", "cumulative_cashflow"]
