...
class EnhancedExitStatisticsResponse(BaseModel):
    ...
    comparison_to_base: Optional[Dict[str, Any]] = Field(default=None, description="Comparison to base exit statistics")
    cohort_analysis: Optional[Dict[str, Any]] = Field(default=None, description="Cohort analysis")
    cohort_analysis_summary: Optional[Dict[str, Any]] = Field(default=None, description="Cohort analysis summary")
    risk_metrics: Optional[Dict[str, Any]] = Field(default=None, description="Risk metrics")
    ml_insights: Optional[Dict[str, Any]] = Field(default=None, description="Machine learning insights")
    __properties: ClassVar[List[str]] = ["avg_exit_year", "avg_roi", "avg_annualized_roi", "exit_type_distribution", "exit_timing_distribution", "exit_roi_distribution", "exit_type_roi", "exit_value_total", "appreciation_share_total", "total_return", "total_roi", "annualized_roi", "comparison_to_base", "cohort_analysis", "cohort_analysis_summary", "risk_metrics", "ml_insights"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comparison_to_base": obj.get("comparison_to_base"),
            "cohort_analysis": obj.get("cohort_analysis"),
            "cohort_analysis_summary": obj.get("cohort_analysis_summary"),
            "risk_metrics": obj.get("risk_metrics"),
            "ml_insights": obj.get("ml_insights")
        })
        return _obj
