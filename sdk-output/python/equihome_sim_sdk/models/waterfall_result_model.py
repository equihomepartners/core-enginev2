...
class WaterfallResultModel(BaseModel):
    ...
    """ # noqa: E501
    distributions: WaterfallDistributionModel = Field(description="Waterfall distribution data")
    clawback_amount: Union[StrictFloat, StrictInt] = Field(description="Clawback amount")
    visualization: WaterfallVisualizationModel = Field(description="Waterfall visualization data")
    __properties: ClassVar[List[str]] = ["distributions", "clawback_amount", "visualization"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "distributions": WaterfallDistributionModel.from_dict(obj["distributions"]) if obj.get("distributions") is not None else None,
            "clawback_amount": obj.get("clawback_amount"),
            "visualization": WaterfallVisualizationModel.from_dict(obj["visualization"]) if obj.get("visualization") is not None else None
        })
        return _obj
