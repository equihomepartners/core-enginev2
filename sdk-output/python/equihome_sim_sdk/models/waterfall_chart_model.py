...
class WaterfallChartModel(BaseModel):
    ...
    """ # noqa: E501
    category: StrictStr = Field(description="Distribution category")
    amount: Union[StrictFloat, StrictInt] = Field(description="Amount distributed")
    __properties: ClassVar[List[str]] = ["category", "amount"]
