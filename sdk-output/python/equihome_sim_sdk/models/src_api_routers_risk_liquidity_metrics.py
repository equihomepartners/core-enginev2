...
class SrcApiRoutersRiskLiquidityMetrics(BaseModel):
    """
    ...
    wal: Union[StrictFloat, StrictInt] = Field(description="Weighted Average Life (WAL)")
    cfar: Dict[str, Any] = Field(description="Cash-flow-at-risk (CFaR) metrics")
    __properties: ClassVar[List[str]] = ["liquidity_score", "expected_exit_lag", "wal", "cfar"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expected_exit_lag": obj.get("expected_exit_lag"),
            "wal": obj.get("wal"),
            "cfar": obj.get("cfar")
        })
        return _obj
