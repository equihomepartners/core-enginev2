...
class CreditMetrics(BaseModel):
    ...
    portfolio_default_rate: Union[StrictFloat, StrictInt] = Field(description="Portfolio default rate (exposure-weighted PD)")
    __properties: ClassVar[List[str]] = ["current_ltv", "stress_ltv", "default_probability", "portfolio_default_rate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "current_ltv": obj.get("current_ltv"),
            "stress_ltv": obj.get("stress_ltv"),
            "default_probability": obj.get("default_probability"),
            "portfolio_default_rate": obj.get("portfolio_default_rate")
        })
        return _obj
