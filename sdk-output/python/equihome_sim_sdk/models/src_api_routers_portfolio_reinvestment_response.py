...
class SrcApiRoutersPortfolioReinvestmentResponse(BaseModel):
    """
    ...
    num_loans: StrictInt = Field(description="Number of loans generated")
    __properties: ClassVar[List[str]] = ["loans", "total_loan_amount", "num_loans"]
